    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    pass2.setError("Password nit Matched");
                    return;
                }
                Toast.makeText(MainActivity.this,"Resgistration Successful",Toast.LENGTH_LONG).show();
                editor.putString("keysusername",usernames);
