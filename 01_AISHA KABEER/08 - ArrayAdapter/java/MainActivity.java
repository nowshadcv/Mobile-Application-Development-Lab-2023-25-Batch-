...
public class MainActivity extends AppCompatActivity {
    String fruits[] = {"banana","apple","orange","dates","cherry"};
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this,R.layout.activity_listview,R.id.textview,fruits);
